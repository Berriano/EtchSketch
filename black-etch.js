...
let slideValue = document.getElementById('slide-bar');
let slideText = document.getElementById('slide-text');

slideText.innerHTML = slideValue.value;
...
let defaultValue = slideValue.defaultValue;
let currentValue = slideValue.value;
